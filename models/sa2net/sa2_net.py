# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 15:58:16 2024

@author: Gavin

Sourced implementation from: https://github.com/mustansarfiaz/SA2-Net/blob/main/SegPC2021_ISIC2018/models/mynet/sasanet.py
"""
...
class SA2Net2D(nn.Module):
    
    def __init__(self, *args, **kwargs):
        super().__init__()
        
        self.backbone = SA2Net(*args, **kwargs)
        self.channels = self.backbone.n_channels
    ...
    def forward(self, x):
        ...
        if self.backbone.training:
            ...
            for y_i in y:
                y_i = y_i.reshape(shape[0], 2, *shape[2:])
                ys.append(y_i)
                
            return tuple(ys)
        
        return y.reshape(shape[0], 2, *shape[2:])
